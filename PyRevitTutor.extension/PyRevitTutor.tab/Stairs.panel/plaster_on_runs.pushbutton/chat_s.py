    ...
    try:
        ...
        for f in geom1.Faces:
            ...
            if result == RVT.BRepBuilderOutcome.Success:
                directShapeType = RVT.DirectShapeType.Create(doc, name1, cat1.Id)
                directShapeType.SetShape(br1)
                directShape = RVT.DirectShape.CreateElementInstance(doc, directShapeType.Id, cat1.Id)
                return ueWrapper.Invoke(None, (directShape, False))
    except:
